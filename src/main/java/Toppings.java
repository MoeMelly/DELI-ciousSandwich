...
public class Toppings implements Serializable {
    ...
    public List<Toppings> toppings(List<Toppings> toppings, String type, String name, Size size) {
    ...
    public static void printToppingsByCategory(List<Toppings> toppings) {
        ...
        String regularToppings = toppings.stream()
                .filter(toppings1 -> "RegularToppings".equalsIgnoreCase(toppings1.getType()))
    ...
    public String toString() {
        ...
        return "------------------------------" + lineSeparator +
                ...
                "Size : " + size + lineSeparator +
                "Price: $" + String.format("%.2f", price) + lineSeparator +
                "------------------------------" + lineSeparator;
